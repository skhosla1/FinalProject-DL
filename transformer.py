...
class StockDataset(Dataset):
    def __init__(self, data, seq_len):
        self.data = data
        percent_change_in_closing = (self.data[1:,4] - self.data[0:-1,4]) / self.data[0:-1,4]
        self.normed_change_in_closing = np.cbrt(percent_change_in_closing) * 1.2446
    ...
    def __getitem__(self, index):
        ...
        y = self.normed_change_in_closing[index+self.seq_len - 1]
